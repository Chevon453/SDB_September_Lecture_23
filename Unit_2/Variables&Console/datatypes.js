...
/*
    ...
    - Think of like an empty container: nothing is in it, but it still exists as a
    space to fill.
*/
let empty = null;
console.log(empty);
...
/*
    ...
    - Basic and most early used data types Datatypes: strings, numbers, booleans, null, undefined.
*/
...
/*
    ...
    3. Each item, regardless of the datatypes, are comma separated.
*/

let burritos = ['large', 2, true];
console.log(burritos);

console.log(typeof burritos); // object, JS defines as a container that can hold multiple datatypes. 
...
console.assert.log(notANumber); // NaN, not a Number